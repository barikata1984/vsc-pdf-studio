...
- [x] **Step 1: Write the failing worker-option assertion**
...
- [x] **Step 3: Configure the bundled worker**
...
- [x] **Step 1: Write failing priority and concurrency tests**
...
- [x] **Step 2: Implement the session render pool**
...
- [x] **Step 3: Apply scroll-direction ordering**
...
- [x] **Step 1: Write the failing thumbnail-cache test**
...
- [x] **Step 2: Implement document-level thumbnail caching**
...
- [x] **Step 3: Trigger generation from the page list**
...
- [x] **Step 1: Write the failing text-cache test**
...
- [x] **Step 2: Cache raw text and build the index once**
...
- [x] **Step 3: Search without all text layers**
...
- [x] **Step 2: Inspect structural invariants**
...
- [x] **Step 3: Run the long-document smoke check**
